...
import {
  LayoutDashboard, FolderOpen, Handshake,
  MessageSquare, CreditCard, Users, User, LogOut, Menu,
} from 'lucide-react'
...
const NAV = [
  ...
  { to: '/client/contracts',   label: 'Contracts',   Icon: Handshake },
  { to: '/client/chat',        label: 'Messages',    Icon: MessageSquare },
  { to: '/client/payments',    label: 'Payments',    Icon: CreditCard },
  { to: '/client/freelancers', label: 'Find Talent', Icon: Users },
...
export default function ClientLayout() {
  ...
  const pageTitle = currentNav?.label ?? 'Client Portal'
