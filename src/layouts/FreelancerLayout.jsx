...
import {
  LayoutDashboard, Briefcase, Handshake,
  MessageSquare, Send, TrendingUp, User, LogOut, Menu,
} from 'lucide-react'
...
const NAV = [
  { to: '/freelancer',           label: 'Dashboard', Icon: LayoutDashboard, end: true },
  { to: '/freelancer/projects',  label: 'Find Work', Icon: Briefcase },
  { to: '/freelancer/contracts', label: 'Contracts', Icon: Handshake },
  { to: '/freelancer/chat',      label: 'Messages',  Icon: MessageSquare },
  { to: '/freelancer/proposals', label: 'My Bids',   Icon: Send },
  { to: '/freelancer/earnings',  label: 'Earnings',  Icon: TrendingUp },
...
export default function FreelancerLayout() {
  ...
  const isChatPage        = location.pathname.startsWith('/freelancer/chat')
  ...
  const pageTitle = currentNav?.label ?? 'Freelancer Portal'
      ...
      <aside className={cn(
        ...
        <div className="p-3 border-t border-slate-200">
          <div className="flex items-center gap-3 px-2 py-2 mb-1">
            <div className="h-8 w-8 rounded-full bg-green-100 text-green-700 text-xs font-bold flex items-center justify-center shrink-0">
